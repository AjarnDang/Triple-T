    ...
    <div className="lg:w-[60%] px-4">
      <div className="mb-12">
        ...
        <p>
          ...
          <a href="https://www.linkedin.com/in/thornthan-jomtharak-b10403279/" target="_blank" className="text-blue-500">
            Thornthan Jomtharak
          </a>{" "}
          a Frontend Developer and UX/UI Designer. It uses Next.js's dynamic
          routing and useState to manage form data and useEffect to fetch data.
          The mock data for this project from <a href="">MeLiveCode</a>
      ...
      <div className="mb-12">
        <h1 className="text-2xl font-bold mb-4">How to Sign In</h1>
        <p className="mb-4">
